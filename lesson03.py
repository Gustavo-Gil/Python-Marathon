def add_food(food, description):
  if food is False or description is False:
    print("Erro, é necessário informar o nome e a descrição da comida.")
  elif type(food) is not str or type(description) is not str:
    print("Erro, favor informar no formato string.")
  elif food in food_list:
    print(f"Erro, {food} já está cadastrado no dicionário.")
  else:
    food_list[food] = description
    print(f"A comida {food} foi adicionada com sucesso!")


def delete_food(food):
  if type(food) is not str:
    print("Erro, favor informar no formato string.")
  elif food not in food_list:
    print(f"Erro, {food} não existe no dicionário.")
  else:
    food_list.pop(food)
    print(f"{food} foi retirado com sucesso!")


def update_food(food, description):
  if food is False or description is False:
    print("Erro, é necessário informar o nome e a descrição da comida.")
  elif type(food) is not str or type(description) is not str:
    print("Erro, favor informar no formato string.")
    ...
    food_list[food] = description
    print(f"A comida {food} foi atualizada com sucesso!")
...
def get_food(food):
  if type(food) is not str:
    ...
    print(f"A descrição da comida {food} é {food_list[food]}")
